...
// in recipe_book/test/unit/main_test.dart.
...
import 'package:recipe_book/features/main/presentation/cubit/main_cubit.dart'
    as _i7;
import 'package:recipe_book/features/meals/domain/entities/meal.dart' as _i6;
...
class MockGetMealsByLetter extends _i1.Mock implements _i4.GetMealsByLetter {
  ...
  @override
  _i5.Future<List<_i6.Meal>> call(String? letter) =>
      (super.noSuchMethod(
            Invocation.method(#call, [letter]),
            returnValue: _i5.Future<List<_i6.Meal>>.value(<_i6.Meal>[]),
          )
          as _i5.Future<List<_i6.Meal>>);
}

/// A class which mocks [MainCubit].
///
/// See the documentation for Mockito's code generation for more information.
class MockMainCubit extends _i1.Mock implements _i7.MainCubit {
  MockMainCubit() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  void setTab(int? index) => super.noSuchMethod(
    Invocation.method(#setTab, [index]),
  ...
  @override
  void onChange(_i8.Change<int>? change) => super.noSuchMethod(
...
class MockSearchBloc extends _i1.Mock implements _i3.SearchBloc {
  ...
  @override
  _i3.SearchState get state =>
      (super.noSuchMethod(
            Invocation.getter(#state),
            returnValue: _FakeSearchState_1(this, Invocation.getter(#state)),
          )
          as _i3.SearchState);
  ...
  void on<E extends _i3.SearchEvent>(
    _i8.EventHandler<E, _i3.SearchState>? handler, {
  ...
  @override
  void onTransition(
    _i8.Transition<_i3.SearchEvent, _i3.SearchState>? transition,
  ) => super.noSuchMethod(
  ...
  @override
  void onChange(_i8.Change<_i3.SearchState>? change) => super.noSuchMethod(
    Invocation.method(#onChange, [change]),
    returnValueForMissingStub: null,
  );
